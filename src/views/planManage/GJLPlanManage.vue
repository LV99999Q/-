<template>
  <div class="GJLPlanManage">
    ...
    <pageModular
      ...
      <el-table-column label="操作" align="center"  width="100" v-if="MIXIN_tabsData.value == '钢筋笼日计划'">
    ...
    <el-dialog
      ...
      <AddGJLPlanManage v-if="MIXIN_dialogData.isShow && MIXIN_dialogData.title != '详情'"></AddGJLPlanManage>
    </el-dialog>
  </div>
</template>
...
import GJLPlanManageDetail from '@/components/GJLPlanManage/GJLPlanManageDetail';
import AddGJLPlanManage from '@/components/GJLPlanManage/AddGJLPlanManage';
...
export default {
  ...
  data() {
    return {
      tabs: [
        {value: '钢筋笼日计划', label: '钢筋笼日计划'},
        {value: '钢筋笼周计划', label: '钢筋笼周计划'}
      ],
