        ...
        <el-form
            ...
            <div class="person">
                ...
                <el-form-item label="部门">
                    <el-select v-model="personnelData.deptId" placeholder="请选择部门" disabled>
                        <el-option 
                ...
                <el-form-item label="岗位" prop="userType">
                    <el-select v-model="personnelData.userType" placeholder="请选择岗位" disabled>
                        <el-option 
                ...
                <el-form-item label="备注">
                    <el-input type="textarea" v-model="personnelData.remark" placeholder="请输入备注" readonly></el-input>
                </el-form-item>
            </div>
    ...
    methods: {
        ...
        initPersonnelData() {
            this.$axios({
                ...
                this.personnelData = Object.assign({}, res.data.data);
            })
        },
        // 获取全部部门
        getAllDepts() {
