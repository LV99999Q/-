        ...
        <el-form
            ...
            <div class="person flex border-b">
                <div class="person-info border-r">
                    ...
                    <el-form-item label="姓名" prop="name">
                        <el-input v-model="personnelData.name" placeholder="请输入姓名" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="性别">
                        <el-radio-group v-model="personnelData.sex" readonly>
                            <el-radio
                    ...
                    <el-form-item label="工号">
                        <el-input v-model="personnelData.employeeNo"  placeholder="请输入工号" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="手机号" prop="phone">
                        <el-input v-model="personnelData.phone"  placeholder="请输入手机号" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="政治面貌">
                        <el-select v-model="personnelData.sociRole" placeholder="请选择政治面貌" disabled>
                            <el-option 
                    ...
                    <el-form-item label="紧急联系人">
                        <el-input v-model="personnelData.emergPeople"  placeholder="请输入紧急联系人" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="联系电话" prop="emergPhone">
                        <el-input v-model="personnelData.emergPhone"  placeholder="请输入联系电话" readonly></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="家庭住址">
                        <el-input v-model="personnelData.address"  placeholder="请输入家庭住址" readonly></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="入职体检报告">
                        <el-button
                            :disabled="fileLoad.entryPhysicalExam == '上传'"
                            @click="previewFile('entryPhysicalExam')">
                            {{ fileLoad.entryPhysicalExam }}
                        </el-button>
                    </el-form-item>
                    <el-form-item label="在岗体检报告">
                        <el-button
                            :disabled="fileLoad.onDutyPhysicalExam == '上传'"
                            @click="previewFile('onDutyPhysicalExam')">
                            {{ fileLoad.onDutyPhysicalExam }}
                        </el-button>
                    </el-form-item>
                    <el-form-item label="离职体检报告">
                        <el-button
                            :disabled="fileLoad.offDutyPhysicalExam == '上传'"
                            @click="previewFile('offDutyPhysicalExam')">
                            {{ fileLoad.offDutyPhysicalExam }}
                        </el-button>
                    </el-form-item>
                    <el-form-item label="选择角色">
                        <el-select v-model="personnelData.level" placeholder="请选择角色" disabled>
                            <el-option 
                    ...
                    <el-form-item label="身份证号" prop="idCardNo">
                        <el-input v-model="personnelData.idCardNo" readonly  placeholder="请输入身份证号"></el-input>
                    </el-form-item>
            ...
            <div class="flex person">
                <div class="person-info">
                    ...
                    <el-form-item label="账号" prop="acount">
                        <el-input v-model="personnelData.acount"  placeholder="请输入账号" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="密码" prop="password">
                        <el-input v-model="personnelData.password"  placeholder="请输入密码" readonly></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="岗位状态" prop="jobStatus">
                        <el-select v-model="personnelData.jobStatus" placeholder="请选择岗位状态" disabled>
                            <el-option 
                    ...
                    <el-form-item label="工种" prop="userType">
                        <el-select v-model="personnelData.userType" placeholder="请选择工种" disabled>
                            <el-option 
                    ...
                    <el-form-item label="所属部门">
                        <el-select v-model="personnelData.deptId" placeholder="请选择所属部门" disabled>
                            <el-option 
            ...
            <div class="person">
                ...
                <el-form-item label="劳务公司">
                    <el-input v-model="personnelData.laborCompany" readonly placeholder="请输入劳务公司"></el-input>
                </el-form-item>
                <el-form-item label="劳务合同">
                    <el-button
                        :disabled="fileLoad.laborContractImg == '上传'"
                        @click="previewFile('laborContractImg')">
                        {{ fileLoad.laborContractImg }}
                    </el-button>
                </el-form-item>
                ...
                <el-form-item label="社保明细">
                    <el-button
                        :disabled="fileLoad.socialSecurityImg == '上传'"
                        @click="previewFile('socialSecurityImg')">
                        {{ fileLoad.socialSecurityImg }}
                    </el-button>
                </el-form-item>
                ...
                <el-form-item label="备注">
                    <el-input type="textarea" v-model="personnelData.remark" readonly placeholder="请输入备注"></el-input>
                </el-form-item>
                ...
                <div v-if="personnelData.haveWorkCertificate">
                    <p v-for="(item, index) in personnelData.certificates" :key="item.key">
                        <el-form-item label="证书">
                            <el-input v-model="item.name" placeholder="请输入证书" readonly></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="证书上传">
                            <el-button
                                :readonly="fileLoad.certificates[index].name == '上传'"
                                @click="previewFile(`certificates-${index}`)">
                                {{ fileLoad.certificates[index].name }}
                            </el-button>
                        </el-form-item>
                    </p>
                </div>
    ...
    methods: {
        ...
        initPersonnelData() {
            ...
            this.$axios({
                ...
                obj = res.data.data;
                obj2 = {
                    entryPhysicalExam: obj.entryPhysicalExam ?'预览' : '上传',
                    onDutyPhysicalExam: obj.onDutyPhysicalExam ?'预览' : '上传',
                    offDutyPhysicalExam: obj.offDutyPhysicalExam ?'预览' : '上传',
                    laborContractImg: obj.laborContractImg ?'预览' : '上传',
                    socialSecurityImg: obj.socialSecurityImg ?'预览' : '上传',
                    certificates: obj.certificates.map(e => {
                        return {name: e.url ? '预览' : '上传'};
                    })
                };
        ...
        previewFile(keyIndex) {
            let [key, index] = keyIndex.split('-'), url = '';
            switch(key) {
                case 'certificates':
                    url = `api${this.personnelData[key][index].url}`;
                    break;
                default:
                    url = `api${this.personnelData[key]}`;
                    break;
            }
            window.open(url)
        }
