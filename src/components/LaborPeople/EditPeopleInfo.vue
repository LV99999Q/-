    ...
    methods: {
        ...
        initPersonnelData() {
            ...
            this.$axios({
                ...
                obj3 = res.data.data;
                obj2 = {
                    entryPhysicalExam: obj3.entryPhysicalExam ?'修改' : '上传',
                    onDutyPhysicalExam: obj3.onDutyPhysicalExam ?'修改' : '上传',
                    offDutyPhysicalExam: obj3.offDutyPhysicalExam ?'修改' : '上传',
                    laborContractImg: obj3.laborContractImg ?'修改' : '上传',
                    socialSecurityImg: obj3.socialSecurityImg ?'修改' : '上传',
                    certificates: obj3.certificates.map(e => {
                        return {name: e.url ? '修改' : '上传'};
                    })
                };
                this.personnelData = Object.assign({}, obj, obj3);
